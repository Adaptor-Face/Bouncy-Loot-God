...
loc_data_table = {
    ...
    "Enemy: Eghood":                                           BLTPSArchiData("Veins of Helios",17, req_locations=["Quest: Eradicate!"]),
    "Enemy: CL4P-L3K":                                         BLTPSArchiData("Veins of Helios",17, req_locations=["Quest: Eradicate!"]),
    "Enemy: Master Poacher":                                   BLTPSArchiData("Vorago Solitude",18, tags=["missable"], req_locations=["Quest: Guardian Hunter"]),
    "Enemy: Dan Zando":                                        BLTPSArchiData("Veins of Helios",17, req_locations=["Quest: Don't Get Cocky"], tags=["missable"]),
    ...
    "Symbol MotherlessBoard: Left Data Tower":                  BLTPSArchiData("Motherlessboard", 30, req_groups=["Oz Kit"], req_items=["Crouch"]),
    ...
    "Challenge Shields: Ammo Eater":                                                BLTPSArchiData("Regolith Range", 14, tags=["general"], req_groups=["Shield"]),
    "Challenge Shields: Amplitude Killulation":                                     BLTPSArchiData("Regolith Range", 15, tags=["general"], req_groups=["Shield"]),
    "Challenge Shields: Nova Say Die":                                              BLTPSArchiData("Regolith Range", 10, tags=["general"], req_groups=["Shield"]),
    "Challenge Shields: Wet Work":                                                  BLTPSArchiData("Regolith Range", 12, tags=["general"], req_groups=["Shield"]),
    "Challenge Shields: That'll Learn Ya":                                          BLTPSArchiData("Regolith Range", 8, tags=["general"], req_groups=["Shield"]),
